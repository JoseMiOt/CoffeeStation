...
import com.coffeestation.databinding.ActivityCafeFrioBinding

class CafeFrio : AppCompatActivity() {

    private lateinit var binding: ActivityCafeFrioBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeFrioBinding.inflate(layoutInflater)
