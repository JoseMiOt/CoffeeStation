...
import com.coffeestation.databinding.ActivityCafeFrappuccinoBinding

class CafeFrappuccino : AppCompatActivity() {

    private lateinit var binding: ActivityCafeFrappuccinoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeFrappuccinoBinding.inflate(layoutInflater)
