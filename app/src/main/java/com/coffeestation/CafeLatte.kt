...
import com.coffeestation.databinding.ActivityCafeLatteBinding

class CafeLatte : AppCompatActivity() {

    private lateinit var binding: ActivityCafeLatteBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeLatteBinding.inflate(layoutInflater)
