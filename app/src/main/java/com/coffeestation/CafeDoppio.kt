...
import com.coffeestation.databinding.ActivityCafeDoppioBinding

class CafeDoppio : AppCompatActivity() {

    private lateinit var binding: ActivityCafeDoppioBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeDoppioBinding.inflate(layoutInflater)
