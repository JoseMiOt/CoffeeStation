...
import com.coffeestation.databinding.ActivityCafeRistrettoBcBinding

class CafeRistrettoBC : AppCompatActivity() {

    private lateinit var binding: ActivityCafeRistrettoBcBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeRistrettoBcBinding.inflate(layoutInflater)
