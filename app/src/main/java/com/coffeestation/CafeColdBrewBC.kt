...
import com.coffeestation.databinding.ActivityCafeColdBrewBcBinding

class CafeColdBrewBC : AppCompatActivity() {

    private lateinit var binding: ActivityCafeColdBrewBcBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeColdBrewBcBinding.inflate(layoutInflater)
