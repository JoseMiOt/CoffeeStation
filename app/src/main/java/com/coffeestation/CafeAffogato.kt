...
import com.coffeestation.databinding.ActivityCafeAffogatoBinding

class CafeAffogato : AppCompatActivity() {

    private lateinit var binding: ActivityCafeAffogatoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeAffogatoBinding.inflate(layoutInflater)
