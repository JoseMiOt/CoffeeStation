...
import com.coffeestation.databinding.ActivityCafeVienesBinding

class CafeVienes : AppCompatActivity() {

    private lateinit var binding: ActivityCafeVienesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeVienesBinding.inflate(layoutInflater)
