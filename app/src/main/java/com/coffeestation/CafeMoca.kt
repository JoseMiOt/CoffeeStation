...
import com.coffeestation.databinding.ActivityCafeMocaBinding

class CafeMoca : AppCompatActivity() {

    private lateinit var binding: ActivityCafeMocaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeMocaBinding.inflate(layoutInflater)
