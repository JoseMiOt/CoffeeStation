...
import com.coffeestation.databinding.ActivityCafeRistrettoBinding

class CafeRistretto : AppCompatActivity() {

    private lateinit var binding: ActivityCafeRistrettoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeRistrettoBinding.inflate(layoutInflater)
