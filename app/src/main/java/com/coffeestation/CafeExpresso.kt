...
import com.coffeestation.databinding.ActivityCafeExpressoBinding

class CafeExpresso : AppCompatActivity() {

    private lateinit var binding: ActivityCafeExpressoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeExpressoBinding.inflate(layoutInflater)
