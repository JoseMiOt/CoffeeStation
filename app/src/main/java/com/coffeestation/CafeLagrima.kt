...
import com.coffeestation.databinding.ActivityCafeLagrimaBinding

class CafeLagrima : AppCompatActivity() {

    private lateinit var binding: ActivityCafeLagrimaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeLagrimaBinding.inflate(layoutInflater)
