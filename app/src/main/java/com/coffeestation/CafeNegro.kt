...
import com.coffeestation.databinding.ActivityCafeNegroBinding

class CafeNegro : AppCompatActivity() {

    private lateinit var binding: ActivityCafeNegroBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeNegroBinding.inflate(layoutInflater)
