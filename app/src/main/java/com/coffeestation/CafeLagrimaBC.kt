...
import com.coffeestation.databinding.ActivityCafeLagrimaBcBinding

class CafeLagrimaBC : AppCompatActivity() {

    private lateinit var binding: ActivityCafeLagrimaBcBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCafeLagrimaBcBinding.inflate(layoutInflater)
